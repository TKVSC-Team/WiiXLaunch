...
def generate_config():
    ...
    # Output directory for generated build configs (keeps submodules 100% clean)
    ...
    # ---------------------------------------------------------
    # 1. Generate program/setting.hpp (Shadows ExLaunch setting header)
    # ---------------------------------------------------------
...
"""
    ...
    # Also keep include/wiixlaunch/generated_setting.hpp for direct WiiXLaunch include
    ...
    # ---------------------------------------------------------
    # 2. Update Switch config.json (NPDM) in build/generated/
    # ---------------------------------------------------------
    npdm_json = {
        "name": proj_name,
    ...
    # ---------------------------------------------------------
    # 3. Update Switch config.mk in build/generated/
    # ---------------------------------------------------------
    config_mk_content = f"""# AUTO-GENERATED BY WiiXLaunch scripts/generate_config.py
LOAD_KIND := {switch_cfg.get("load_kind", "Module")}
PROGRAM_ID := {title_id}
...
"""
    ...
    # ---------------------------------------------------------
    # 4. Generate Wii U WUPS Header Config
    # ---------------------------------------------------------
